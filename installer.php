...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210211_cakehouse_f0f4efb7d69540049690_20210211202350_archive.zip';
	const ARCHIVE_SIZE		 = '93729053';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f0f4efb-11202350';
	const VERSION			 = '3.8.5.1';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.5.1==');
		self::log('----------------------------------------------------');
